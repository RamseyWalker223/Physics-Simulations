...
int main(){
    ...
    glm::mat4 projection;
    projection = glm::perspective(glm::radians(45.0f), aspect, 0.0001f, 100.0f);
    ...
    texture image("../res/textures/image.png");
    image.bind();
    ...
    while(!glfwWindowShouldClose(window)){
        ...
        Δtime = current_frame - last_frame;
        last_frame = current_frame;
        float cameraSpeed = 2.5f * Δtime;
